...
export default function DeviceEndpointProtectionService() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "HIPAA-compliant endpoint management across 200 devices. Real-time monitoring detected and contained a ransomware attempt within 30 seconds, saving our patient data.",
      employees: "100-250",
