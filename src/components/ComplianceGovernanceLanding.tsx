...
import { Shield, CheckCircle, AlertTriangle, Users, Award, FileText, Database, Lock, Phone, Mail, Building, User, X, Scale, Gavel } from 'lucide-react';
...
const ComplianceGovernanceLanding: React.FC = () => {
  ...
  const assessmentFeatures = [
    {
      ...
      description: "Assessment against GDPR, HIPAA, SOX, and industry-specific regulations"
    },
    {
      icon: <FileText className="h-6 w-6" />,
      title: "Policy & Procedure Audit",
      description: "Review of existing governance frameworks and documentation"
    },
    {
      icon: <Database className="h-6 w-6" />,
      title: "Data Governance Analysis",
      description: "Evaluate data classification, retention, and privacy controls"
    },
    {
      icon: <Lock className="h-6 w-6" />,
      title: "Access Control Assessment",
      description: "Review user permissions, privileged access, and segregation of duties"
    },
    {
      icon: <Gavel className="h-6 w-6" />,
      title: "Risk Management Framework",
      description: "Assess risk identification, mitigation strategies, and reporting"
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Certification Readiness",
      description: "Preparation for ISO 27001, SOC 2, and other compliance certifications"
    }
  ];
  ...
  const benefits = [
    ...
    "Regulatory roadmap recommendations",
    "Zero obligation to implement suggestions",
    "Senior compliance consultant-led assessment"
  ];

  const trustIndicators = [
    { icon: <Award className="h-8 w-8" />, text: "ISO 27001 Certified" },
    { icon: <Shield className="h-8 w-8" />, text: "GDPR Specialists" },
    { icon: <Users className="h-8 w-8" />, text: "200+ Compliance Reviews" },
    { icon: <CheckCircle className="h-8 w-8" />, text: "100% Audit Success" }
  ];
        ...
        <div className="max-w-2xl mx-auto text-center relative">
          <div className="bg-white rounded-2xl shadow-2xl p-12 relative">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">
              Compliance Assessment Request Submitted!
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Thank you for your interest in our FREE Compliance & Governance Assessment.
              Our senior compliance consultant will contact you within 24 hours to schedule your evaluation.
            </p>
            <div className="bg-green-50 rounded-lg p-6 mb-6">
              ...
              <ul className="text-green-800 space-y-2 text-left">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 mr-2 text-green-600" />
                  Schedule your 3-hour compliance review
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 mr-2 text-green-600" />
                  Receive comprehensive compliance report
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-white/20">
                <h2 className="text-2xl font-bold text-white mb-4">
                  Exclusive, Limited-Time Offer: Complimentary Compliance & Governance Assessment
                </h2>
                <p className="text-lg text-emerald-100 mb-6">
                  <span className="text-yellow-400 font-semibold">Worth £5,000 - Yours Free</span> As An R2 System Solution Ltd Client
                </p>
              ...
              <div className="bg-white rounded-2xl p-8 mb-12 shadow-2xl">
                ...
                <div className="space-y-4">
                  {[
                    "If your organization meets current regulatory requirements",
                    "Where compliance gaps exist and how to address them",
                    "Whether your governance framework supports business objectives",
                    "How prepared you are for regulatory audits",
                    "Your data privacy and protection compliance status"
                  ].map((item, index) => (
                    <div key={index} className="flex items-start space-x-3">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8">
                <div className="bg-white rounded-2xl shadow-2xl p-8 border-4 border-yellow-400">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">
                      Claim Your Free Compliance & Governance Assessment
                    </h3>
                ...
                <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <h4 className="text-white font-semibold mb-4 text-center">Trusted Compliance Partners</h4>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            67% of businesses fail their first compliance audit. Ensure your organization is ready today.
          </p>
          <button
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                <h3 className="text-2xl font-bold text-gray-900">About Ridwan Akorede, CISA</h3>
                <button
              ...
              <div className="flex items-start space-x-6 mb-6">
                ...
                />
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-2">Senior Compliance & Governance Consultant</h4>
                  <p className="text-gray-600 mb-4">
                    15+ years of regulatory compliance and governance experience
                  </p>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Ridwan Akorede is a distinguished compliance and governance consultant with over 15 years of 
                  expertise in regulatory frameworks and risk management. As a Certified Information Systems 
                  Auditor (CISA) and ISO 27001 Lead Auditor, he brings comprehensive knowledge of compliance 
                  requirements across multiple industries.
                </p>
                <p>
                  Throughout his career, Ridwan has conducted compliance assessments for over 200 organizations, 
                  helping them achieve and maintain regulatory compliance while building robust governance 
                  frameworks. His expertise spans GDPR, SOX, PCI DSS, and industry-specific regulations.
                </p>
                <p>
                  Ridwan's approach focuses on practical compliance solutions that align with business objectives 
                  while minimizing operational burden and ensuring sustainable compliance programs.
                </p>
              </div>
              
              <div className="mt-8 bg-emerald-50 rounded-lg p-6">
                <h5 className="font-semibold text-emerald-900 mb-2">Recent Achievements:</h5>
                <ul className="text-emerald-800 space-y-1">
                  <li>• Achieved 100% audit success rate for clients over 5 years</li>
                  <li>• Led GDPR compliance for 80+ multinational organizations</li>
                  <li>• Reduced compliance costs by 50% through process optimization</li>
                  <li>• Speaker at International Association of Privacy Professionals events</li>
                </ul>
              </div>
            </div>
          </div>
...
export default ComplianceGovernanceLanding;