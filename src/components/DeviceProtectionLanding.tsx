...
const DeviceProtectionLanding: React.FC = () => {
  const [formData, setFormData] = useState<FormData>({
    fullName: '',
    companyName: '',
    businessEmail: '',
    phoneNumber: '',
    serviceCategory: 'Device and Endpoint Protection',
  });
  ...
  const assessmentFeatures = [
    {
      ...
      description: "Complete evaluation of all devices, security software, and protection policies"
    },
    {
      icon: <Lock className="h-6 w-6" />,
      title: "Access Control Assessment",
      description: "Review user permissions, authentication systems, and access management"
    },
    {
      icon: <Eye className="h-6 w-6" />,
      title: "Threat Detection Analysis",
      description: "Evaluate monitoring capabilities and incident response procedures"
    },
    {
      icon: <AlertTriangle className="h-6 w-6" />,
      title: "Vulnerability Identification",
      description: "Identify security gaps, outdated software, and potential attack vectors"
    },
    {
      icon: <Database className="h-6 w-6" />,
      title: "Data Protection Review",
      description: "Assess encryption, backup security, and data loss prevention measures"
    },
    {
      icon: <Monitor className="h-6 w-6" />,
      title: "Device Management Evaluation",
      description: "Review mobile device policies, BYOD security, and endpoint compliance"
    }
  ];

  const benefits = [
    "Completely confidential security evaluation",
    "No disruption to daily operations",
    "Comprehensive Security Risk Report",
    "Strategic cybersecurity roadmap recommendations",
    "Zero obligation to implement suggestions",
    "Senior cybersecurity consultant-led assessment"
  ];

  const trustIndicators = [
    { icon: <Award className="h-8 w-8" />, text: "CISSP Certified" },
    { icon: <Shield className="h-8 w-8" />, text: "Security+ Validated" },
    { icon: <Users className="h-8 w-8" />, text: "500+ Security Audits" },
    { icon: <CheckCircle className="h-8 w-8" />, text: "100% Threat Detection" }
  ];
        ...
        <div className="max-w-2xl mx-auto text-center relative">
          <div className="bg-white rounded-2xl shadow-2xl p-12 relative">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">
              Security Assessment Request Submitted!
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Thank you for your interest in our FREE Device & Endpoint Protection Assessment.
              Our senior cybersecurity consultant will contact you within 24 hours to schedule your evaluation.
            </p>
            <div className="bg-red-50 rounded-lg p-6 mb-6">
              ...
              <ul className="text-red-800 space-y-2 text-left">
                <li className="flex items-center">
                  ...
                  Initial security consultation call (15 minutes)
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 mr-2 text-red-600" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 mr-2 text-red-600" />
                  Receive detailed cybersecurity risk report
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <div className="inline-flex items-center bg-red-500/20 text-red-200 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  URGENT - 93% of Cyberattacks Target Endpoints
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  FREE Device & Endpoint
                  <span className="text-yellow-400"> Protection Assessment</span>
                </h1>
                <p className="text-xl md:text-2xl text-red-100 mb-8 leading-relaxed">
                  Secure Your Business Devices & Protect Against Cyber Threats - No Obligation
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-white/20">
                <h2 className="text-2xl font-bold text-white mb-4">
                  Exclusive, Limited-Time Offer: Complimentary Cybersecurity Risk Assessment
                </h2>
                <p className="text-lg text-red-100 mb-6">
                  <span className="text-yellow-400 font-semibold">Worth &pound;4,500 - Yours Free</span> As An R2 System Solution Ltd Client
                </p>
                    ...
                    {assessmentFeatures.map((feature, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-200">{feature.description}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="bg-white rounded-2xl p-8 mb-12 shadow-2xl">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Your Comprehensive Security Assessment Will Reveal:
                </h2>
                <div className="space-y-4">
                  {[
                    "How vulnerable your devices are to ransomware and malware attacks",
                    "Whether your current security measures can prevent data breaches",
                    "If your remote work setup exposes critical business information",
                    "How prepared you are for sophisticated cyber threats",
                    "Your compliance status with industry security standards"
                  ].map((item, index) => (
                    <div key={index} className="flex items-start space-x-3">
              ...
              {/* Threat Statistics */}
              <div className="bg-gradient-to-r from-gray-900 to-red-900 rounded-2xl p-8 mb-12 text-white">
                <h2 className="text-2xl font-bold mb-6">Alarming Cybersecurity Statistics:</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-yellow-400 mb-2">68%</div>
                    <p className="text-sm">of businesses experienced endpoint attacks in 2023</p>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-yellow-400 mb-2">&pound;4.45M</div>
                    <p className="text-sm">average cost of a data breach</p>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-yellow-400 mb-2">277</div>
                    <p className="text-sm">days to identify and contain a breach</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8">
                <div className="bg-white rounded-2xl shadow-2xl p-8 border-4 border-yellow-400">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">
                      Claim Your Free Cybersecurity Assessment
                    </h3>
                    <p className="text-gray-600">Complete the form below to secure your business</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          value="Device and Endpoint Protection"
                          readOnly
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent bg-gray-50"
                          placeholder="Device and Endpoint Protection"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-red-600 to-orange-700 text-white font-bold py-4 px-6 rounded-lg hover:from-red-700 hover:to-orange-800 transform hover:scale-105 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                ...
                <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <h4 className="text-white font-semibold mb-4 text-center">Trusted Security Certifications</h4>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Every 11 seconds, a business falls victim to ransomware. Secure your endpoints before it's too late.
          </p>
          <button
            onClick={() => document.getElementById('fullName')?.focus()}
            className="bg-gradient-to-r from-red-600 to-orange-700 text-white font-bold py-4 px-8 rounded-lg hover:from-red-700 hover:to-orange-800 transform hover:scale-105 transition-all duration-200 shadow-lg text-lg"
          >
...
export default DeviceProtectionLanding;
